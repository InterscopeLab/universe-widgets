...
class re extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,n)=>{const i=n?.renderBefore??t;let r=i._$litPart$;if(void 0===r){const e=n?.renderBefore??null;i._$litPart$=r=new Z(t.insertBefore(I(),e),e,void 0,n??{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return H}}re._$litElement$=!0,re.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:re});const oe=globalThis.litElementPolyfillSupport;oe?.({LitElement:re}),(globalThis.litElementVersions??=[]).push("4.1.1");var se,ae="basil",le="https://js.stripe.com",ce="".concat(le,"/").concat(ae,"/stripe.js"),de=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,he=/^https:\/\/js\.stripe\.com\/(v3|[a-z]+)\/stripe\.js(\?.*)?$/,pe=function(e){var t=document.createElement("script");t.src="".concat(ce).concat("");var n=document.head||document.body;if(!n)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return n.appendChild(t),t},me=null,ue=null,ge=null,ve=function(e){return null!==me?me:(me=new Promise((function(t,n){if("undefined"!=typeof window&&"undefined"!=typeof document)if(window.Stripe)t(window.Stripe);else try{var i=function(){for(var e,t=document.querySelectorAll('script[src^="'.concat(le,'"]')),n=0;n<t.length;n++){var i=t[n];if(e=i.src,de.test(e)||he.test(e))return i}return null}();if(i&&e);else if(i){if(i&&null!==ge&&null!==ue){var r;i.removeEventListener("load",ge),i.removeEventListener("error",ue),null===(r=i.parentNode)||void 0===r||r.removeChild(i),i=pe()}}else i=pe();ge=function(e,t){return function(){window.Stripe?e(window.Stripe):t(new Error("Stripe.js not available"))}}(t,n),ue=function(e){return function(t){e(new Error("Failed to load Stripe.js",{cause:t}))}}(n),i.addEventListener("load",ge),i.addEventListener("error",ue)}catch(e){return void n(e)}else t(null)})),me.catch((function(e){return me=null,Promise.reject(e)})))},be=!1,fe=function(){return se||(se=ve(null).catch((function(e){return se=null,Promise.reject(e)})))};Promise.resolve().then((function(){return fe()})).catch((function(e){be||console.warn(e)}));var ye=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];be=!0;var i=Date.now();return fe().then((function(e){return function(e,t,n){if(null===e)return null;var i=t[0].match(/^pk_test/),r=function(e){return 3===e?"v3":e}(e.version),o=ae;i&&r!==o&&console.warn("Stripe.js@".concat(r," was loaded on the page, but @stripe/stripe-js@").concat("7.3.1"," expected Stripe.js@").concat(o,". This may result in unexpected behavior. For more information, see https://docs.stripe.com/sdks/stripejs-versioning"));var s=e.apply(void 0,t);return function(e,t){e&&e._registerWrapper&&e._registerWrapper({name:"stripe-js",version:"7.3.1",startTime:t})}(s,n),s}(e,t,i)}))};class $e extends re{couponCode="";couponStatus=null;discountPercent=0;discountedTotal=null;static properties={widgetId:{type:String},color:{type:String},loading:{type:Boolean},stripeConfig:{type:Object},services:{type:Object},globalAdditionalServices:{type:Array},squareFootagePricing:{type:Array},selectedService:{type:Object},selectedExtras:{type:Array},selectedSquareFootage:{type:Object},currentStep:{type:Number},showServiceDetails:{type:Boolean},paymentProcessing:{type:Boolean},paymentError:{type:String},bookingData:{type:Object},cardData:{type:Object},businessHours:{type:Object},formError:{type:String}};constructor(){super(),this.widgetId="",this.color="#6366f1",this.loading=!1,this.stripeConfig=null,this.services=new Map,this.globalAdditionalServices=[],this.squareFootagePricing=[],this.selectedService=null,this.selectedExtras=[],this.selectedSquareFootage=null,this.currentStep=1,this.showServiceDetails=!1,this.paymentProcessing=!1,this.paymentError="",this.bookingData={serviceInfo:null,schedule:{date:"",time:"",frequency:"one-time",notes:""},generalInfo:{name:"",email:"",phone:"",address:"",postalCode:"",state:""},payment:{method:"card"},additionalData:[]},this.cardData={cardNumber:"",cardName:"",expiryDate:"",cvv:""},this.bathroomOptions=[{label:"Full bathroom (sink + toilet + shower and/or tub)",value:"full_bathroom"},{label:"Powder room (sink + toilet)",value:"powder_room"},{label:"Master bath (usually larger, often with double sink)",value:"master_bath"},{label:"Guest bath",value:"guest_bath"},{label:"En suite bath (connected to bedroom)",value:"en_suite_bath"},{label:"Staff bath",value:"staff_bath"},{label:"Pool bath (next to pool or outdoor area)",value:"pool_bath"}],this.selectedBathrooms=[],this.selectedBathroom="",this.apiSecret="booking-d9e180f3-d77d-4c25-a163-4605c8ddfb48",this.businessHours={start:7,end:17},this.formError=""}handleBathroomRadio(e){const{value:t}=e.target;this.selectedBathroom=t;const n=this.bathroomOptions.find((e=>e.value===t)),i=n?n.label:t;this.bookingData={...this.bookingData,additionalData:i},console.log("🛁 [BathroomType Selected]",{selectedBathroom:t,additionalData:this.bookingData.additionalData}),this.requestUpdate()}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this.setupGlobalStyles(),this.fetchBookingSettings().then((()=>this.initializeStripe()))}setupGlobalStyles(){if(!document.getElementById("booking-widget-global-styles")){const e=document.createElement("style");e.id="booking-widget-global-styles",e.textContent='\n        :root {\n          --primary-color: #6366f1;\n          --primary-light: #a5b4fc;\n          --primary-dark: #4f46e5;\n          --text-color: #1e293b;\n          --light-gray: #f8fafc;\n          --medium-gray: #e2e8f0;\n          --dark-gray: #94a3b8;\n          --success-color: rgb(2, 148, 46);\n          --error-color: #ef4444;\n          --border-radius: 12px;\n          --box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1),\n                        0 4px 6px -2px rgba(0, 0, 0, 0.05);\n          --transition: all 0.3s ease;\n        }\n        \n        /* Todos tus otros estilos CSS aquí */\n        .container {\n          max-width: 1200px;\n          margin: 0 auto;\n          padding: 2rem 1rem;\n          color: var(--text-color);\n        }\n        \n        * {\n      box-sizing: border-box;\n      margin: 0;\n      padding: 0;\n    }\n\n    html {\n      scroll-behavior: smooth;\n    }\n\n    .container {\n      max-width: 1200px;\n      margin: 0 auto;\n      padding: 2rem 1rem;\n      color: var(--text-color);\n    }\n\n    h1,\n    h2,\n    h3,\n    h4 {\n      text-align: center;\n      margin-bottom: 1.5rem;\n      font-weight: 600;\n      color: var(--primary-dark);\n    }\n\n    h3 {\n      font-size: 1.5rem;\n      margin-bottom: 2rem;\n    }\n\n    /* Step Indicator */\n    .step-indicator {\n      display: flex;\n      justify-content: center;\n      margin-bottom: 3rem;\n      position: relative;\n    }\n\n    .step-progress {\n      position: absolute;\n      top: 15px;\n      left: 0;\n      right: 0;\n      height: 4px;\n      background: var(--medium-gray);\n      z-index: 1;\n    }\n\n    .step-progress-bar {\n      height: 100%;\n      background: var(--primary-color);\n      transition: width 0.3s ease;\n    }\n\n    .steps-container {\n      display: flex;\n      justify-content: space-between;\n      width: 100%;\n      position: relative;\n      z-index: 2;\n    }\n\n    .step {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n    }\n\n    .step-number {\n      width: 32px;\n      height: 32px;\n      border-radius: 50%;\n      background-color: var(--medium-gray);\n      color: var(--text-color);\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      margin-bottom: 0.5rem;\n      font-weight: 500;\n      border: 3px solid white;\n    }\n\n    .step.active .step-number {\n      background-color: var(--primary-color);\n      color: white;\n    }\n\n    .step.completed .step-number {\n      background-color: var(--success-color);\n      color: white;\n    }\n\n    .step-label {\n      font-size: 0.875rem;\n      font-weight: 500;\n      color: var(--dark-gray);\n      text-align: center;\n      max-width: 80px;\n    }\n\n    .step.active .step-label,\n    .step.completed .step-label {\n      color: var(--text-color);\n      font-weight: 600;\n    }\n\n    /* Service Cards */\n    .selection-grid {\n      display: grid;\n      grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));\n      gap: 1.5rem;\n      margin: 2rem 0;\n    }\n\n    .service-card {\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      padding: 1rem;\n      cursor: pointer;\n      transition: var(--transition);\n    }\n\n    .service-card.selected {\n      /* Estilos para la tarjeta seleccionada */\n      border-color: #1976d2; /* ejemplo: azul primario */\n      background: #e3f2fd; /* ejemplo: azul muy claro de fondo */\n      /* Puedes ajustar colores/borde según tu diseño, o usar variables CSS compartidas */\n    }\n\n    .service-card:hover {\n      box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1),\n        0 10px 10px -5px rgba(0, 0, 0, 0.04);\n    }\n\n    .service-card.selected::before {\n      content: "";\n      position: absolute;\n      top: 0;\n      left: 0;\n      right: 0;\n      height: 4px;\n      background: var(--primary-color);\n    }\n\n    .card-header {\n      padding: 1.5rem;\n      text-align: center;\n      border-bottom: 1px solid var(--medium-gray);\n    }\n\n    .card-title {\n      font-size: 1.25rem;\n      font-weight: 600;\n      margin-bottom: 0.5rem;\n      color: var(--primary-dark);\n    }\n\n    .card-price {\n      font-size: 1.75rem;\n      font-weight: 700;\n      color: var(--primary-color);\n      margin: 1rem 0;\n    }\n\n    .card-body {\n      padding: 1.5rem;\n    }\n\n    .benefits-list {\n      list-style: none;\n      padding: 0;\n      margin: 0;\n    }\n\n    .benefits-list li {\n      position: relative;\n      padding-left: 1.75rem;\n      margin-bottom: 0.75rem;\n      line-height: 1.5;\n    }\n\n    .benefits-list li::before {\n      content: "✓";\n      position: absolute;\n      left: 0;\n      color: var(--success-color);\n      font-weight: bold;\n    }\n\n    .size-selection select {\n      width: 100%;\n      padding: 0.75rem;\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      font-size: 1rem;\n      transition: var(--transition);\n    }\n    .size-selection select:focus {\n      border-color: var(--primary-color);\n      box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.2);\n    }\n    .card-content {\n      padding: 1rem;\n    }\n    .extra-item img {\n      flex-shrink: 0;\n    }\n    .service-card {\n      position: relative;\n    }\n\n    .img-services {\n      width: 100%;\n      height: 150px;\n      object-fit: cover;\n      border-radius: var(--border-radius);\n    }\n    .img-extras {\n      width: 64px;\n      height: 64px;\n      object-fit: contain;\n      display: block;\n      margin: 0 auto;\n      border-radius: var(--border-radius);\n    }\n\n    /* Service Details */\n    .service-details-container {\n      background: white;\n      border-radius: var(--border-radius);\n      padding: 2rem;\n      margin-top: 2rem;\n      box-shadow: var(--box-shadow);\n    }\n\n    .details-header {\n      display: flex;\n      justify-content: space-between;\n      align-items: center;\n      margin-bottom: 2rem;\n    }\n\n    .details-header h3 {\n      margin: 0;\n      text-align: left;\n    }\n\n    .back-button {\n      background: none;\n      border: none;\n      color: var(--primary-color);\n      font-weight: 600;\n      cursor: pointer;\n      display: flex;\n      align-items: center;\n      gap: 0.5rem;\n    }\n\n    /* Size Selection */\n    .size-selection {\n      margin-bottom: 2rem;\n    }\n\n    .size-options {\n      display: grid;\n      grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));\n      gap: 1rem;\n      margin-top: 1rem;\n    }\n\n    .size-option {\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      padding: 1rem;\n      cursor: pointer;\n      transition: var(--transition);\n    }\n\n    .size-option:hover {\n      border-color: var(--primary-light);\n    }\n\n    .size-option.selected {\n      border: 2px solid var(--primary-color);\n      box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.2);\n      background-color: rgba(99, 102, 241, 0.05);\n    }\n\n    .size-range {\n      font-weight: 600;\n      margin-bottom: 0.5rem;\n    }\n\n    .size-price {\n      color: var(--primary-color);\n      font-weight: 700;\n      font-size: 1.25rem;\n    }\n\n    .size-time {\n      color: var(--dark-gray);\n      font-size: 0.875rem;\n    }\n\n    /* Extras Section */\n    .extras-section {\n      margin-bottom: 2rem;\n    }\n\n    .extras-grid {\n      display: grid;\n      grid-template-columns: repeat(auto-fill, minmax(240px, 1fr));\n      gap: 1rem;\n      margin-top: 1rem;\n    }\n\n    .extra-item {\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      padding: 1rem;\n      display: flex;\n      align-items: center;\n      gap: 1rem;\n      cursor: pointer;\n      transition: var(--transition);\n    }\n\n    .extra-item:hover {\n      border-color: var(--primary-light);\n    }\n\n    .extra-item.selected {\n      border-color: var(--primary-color);\n      background-color: rgba(99, 102, 241, 0.05);\n    }\n\n    .extra-item input {\n      accent-color: var(--primary-color);\n    }\n\n    .extra-price {\n      margin-left: auto;\n      font-weight: 600;\n      color: var(--primary-color);\n    }\n\n    .extra-time {\n      color: var(--dark-gray);\n      font-size: 0.875rem;\n    }\n\n    /* Summary Card */\n    .summary-card {\n      background: white;\n      border-radius: var(--border-radius);\n      padding: 1.5rem;\n      margin-top: 2rem;\n      box-shadow: var(--box-shadow);\n      border-top: 4px solid var(--primary-color);\n    }\n\n    .summary-title {\n      font-size: 1.25rem;\n      font-weight: 600;\n      margin-bottom: 1rem;\n      color: var(--primary-dark);\n      text-align: center;\n    }\n\n    .summary-item {\n      display: flex;\n      justify-content: space-between;\n      margin-bottom: 0.75rem;\n      padding-bottom: 0.75rem;\n      border-bottom: 1px solid var(--medium-gray);\n    }\n\n    .summary-total {\n      font-weight: 700;\n      font-size: 1.25rem;\n      color: var(--primary-dark);\n      margin-top: 1rem;\n      padding-top: 0.75rem;\n      border-top: 1px solid var(--medium-gray);\n    }\n\n    /* Buttons */\n    .confirm-button {\n      width: 100%;\n      padding: 1rem;\n      background-color: var(--primary-color);\n      color: white;\n      border: none;\n      border-radius: var(--border-radius);\n      font-weight: 600;\n      font-size: 1rem;\n      cursor: pointer;\n      transition: var(--transition);\n      margin-top: 2rem;\n    }\n\n    .confirm-button:hover {\n      background-color: var(--primary-dark);\n      transform: translateY(-2px);\n    }\n\n    /* Form Styles */\n    .form-container {\n      background: white;\n      border-radius: var(--border-radius);\n      padding: 2rem;\n      box-shadow: var(--box-shadow);\n      max-width: 600px;\n      margin: 0 auto;\n    }\n\n    .form-group {\n      margin-bottom: 1.5rem;\n    }\n\n    label {\n      display: block;\n      margin-bottom: 0.5rem;\n      font-weight: 500;\n      color: var(--text-color);\n    }\n\n    input,\n    select {\n      width: 100%;\n      padding: 0.75rem 1rem;\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      font-size: 1rem;\n      transition: var(--transition);\n    }\n\n    input:focus,\n    select:focus {\n      outline: none;\n      border-color: var(--primary-color);\n      box-shadow: 0 0 0 3px rgba(99, 102, 241, 0.2);\n    }\n\n    /* Navigation Buttons */\n    .navigation-buttons {\n      display: flex;\n      justify-content: space-between;\n      margin-top: 2rem;\n    }\n\n    button {\n      padding: 0.75rem 1.5rem;\n      background-color: var(--primary-color);\n      color: white;\n      border: none;\n      border-radius: var(--border-radius);\n      cursor: pointer;\n      font-weight: 500;\n      transition: var(--transition);\n      display: inline-flex;\n      align-items: center;\n      justify-content: center;\n      font-size: 1rem;\n    }\n\n    button:hover {\n      background-color: var(--primary-dark);\n      transform: translateY(-2px);\n    }\n\n    button:disabled {\n      background-color: var(--dark-gray);\n      cursor: not-allowed;\n      transform: none;\n      opacity: 0.7;\n    }\n\n    button.secondary {\n      background-color: white;\n      color: var(--primary-color);\n      border: 1px solid var(--primary-color);\n    }\n\n    button.secondary:hover {\n      background-color: var(--light-gray);\n    }\n\n    /* Confirmation */\n    .confirmation-container {\n      background: white;\n      border-radius: var(--border-radius);\n      padding: 3rem;\n      text-align: center;\n      box-shadow: var(--box-shadow);\n      max-width: 600px;\n      margin: 0 auto;\n    }\n\n    .confirmation-icon {\n      font-size: 4rem;\n      color: var(--success-color);\n      margin-bottom: 1.5rem;\n    }\n\n    .confirmation-title {\n      font-size: 1.75rem;\n      font-weight: 700;\n      margin-bottom: 1rem;\n      color: var(--primary-dark);\n    }\n\n    .confirmation-message {\n      font-size: 1.1rem;\n      margin-bottom: 2rem;\n      line-height: 1.6;\n      color: var(--text-color);\n    }\n\n    .error-message {\n      color: var(--error-color);\n      font-weight: 500;\n      font-size: 1.2rem;\n      margin-top: 2rem;\n      margin-bottom: 2rem;\n      text-align: center;\n      \n    }\n\n    /* Payment Section Styles */\n    .payment-section {\n      background: white;\n      border-radius: var(--border-radius);\n      padding: 1.5rem;\n      margin-bottom: 1.5rem;\n      box-shadow: var(--box-shadow);\n      border: 1px solid var(--medium-gray);\n    }\n\n    .payment-section-header {\n      display: flex;\n      align-items: center;\n      margin-bottom: 1.5rem;\n    }\n\n    .payment-icon {\n      width: 40px;\n      height: 40px;\n      background-color: var(--primary-light);\n      border-radius: 50%;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      margin-right: 1rem;\n      color: var(--primary-dark);\n      font-size: 1.25rem;\n    }\n\n    .payment-title {\n      font-size: 1.25rem;\n      font-weight: 600;\n      color: var(--primary-dark);\n    }\n\n    .payment-methods {\n      margin-top: 1.5rem;\n    }\n\n    .payment-method {\n      display: flex;\n      align-items: center;\n      padding: 0.75rem;\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      margin-bottom: 0.75rem;\n      cursor: pointer;\n      transition: var(--transition);\n    }\n\n    .payment-method:hover {\n      border-color: var(--primary-color);\n    }\n\n    .payment-method.selected {\n      border: 2px solid var(--primary-color);\n      background-color: rgba(99, 102, 241, 0.05);\n    }\n\n    .payment-method-icon {\n      width: 30px;\n      height: 30px;\n      margin-right: 1rem;\n      color: var(--primary-color);\n    }\n\n    .payment-method-info {\n      flex-grow: 1;\n    }\n\n    .payment-method-title {\n      font-weight: 600;\n      margin-bottom: 0.25rem;\n    }\n\n    .payment-method-description {\n      font-size: 0.875rem;\n      color: var(--dark-gray);\n    }\n\n    /* Stripe Element Styles */\n    #card-element-container {\n      margin: 1.5rem 0;\n    }\n\n    #card-element {\n      border: 1px solid var(--medium-gray);\n      border-radius: var(--border-radius);\n      padding: 12px;\n      background: white;\n      transition: var(--transition);\n    }\n\n    #card-element.StripeElement--focus {\n      border-color: var(--primary-color);\n      box-shadow: 0 0 0 1px var(--primary-color);\n    }\n\n    #card-element.StripeElement--invalid {\n      border-color: var(--error-color);\n    }\n\n    #card-element.StripeElement--complete {\n      border-color: var(--success-color);\n    }\n\n    .card-hint {\n      font-size: 0.875rem;\n      color: var(--dark-gray);\n      margin-top: 0.5rem;\n      text-align: center;\n    }\n\n    /* Loading State */\n    .loading {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      height: 200px;\n    }\n\n    .spinner {\n      width: 40px;\n      height: 40px;\n      border: 4px solid var(--primary-light);\n      border-top: 4px solid var(--primary-color);\n      border-radius: 50%;\n      animation: spin 1s linear infinite;\n    }\n\n    @keyframes spin {\n      0% {\n        transform: rotate(0deg);\n      }\n      100% {\n        transform: rotate(360deg);\n      }\n    }\n\n    /* Responsive */\n    @media (max-width: 768px) {\n      .selection-grid,\n      .size-options,\n      .extras-grid {\n        grid-template-columns: 1fr;\n      }\n\n      .details-header {\n        flex-direction: column;\n        align-items: flex-start;\n        gap: 1rem;\n      }\n\n      .step-label {\n        display: none;\n      }\n      ',document.head.appendChild(e)}}updateGlobalStyles(){const e=document.getElementById("booking-widget-global-styles");if(e){const t=e.textContent.replace(/--primary-color:.*?;/g,`--primary-color: ${this.color};`).replace(/--primary-light:.*?;/g,`--primary-light: ${this.adjustColor(this.color,20)};`).replace(/--primary-dark:.*?;/g,`--primary-dark: ${this.adjustColor(this.color,-20)};`);e.textContent=t}}async initializeStripe(){if(!this.stripeConfig?.publicKey)return console.error("Stripe public key is not provided"),void(this.paymentError="Stripe public key is missing.");try{if(this.stripe=await ye(this.stripeConfig.publicKey,{locale:"en"}),!this.stripe)throw new Error("Failed to initialize Stripe.");console.log("Stripe has been successfully initialized.")}catch(e){console.error("Error loading Stripe:",e),this.paymentError="Failed to initialize Stripe. Please try again later."}}async setupStripeElement(){if(4!==this.currentStep||this.cardElement)return;await this.updateComplete;const e=this.renderRoot?.querySelector("#card-element");if(!e)return void setTimeout((()=>this.setupStripeElement()),100);const t=this.stripe.elements();this.cardElement=t.create("card",{style:{base:{color:"#32325d",fontFamily:'"Inter", sans-serif',fontSmoothing:"antialiased",fontSize:"16px","::placeholder":{color:"#aab7c4"}},invalid:{color:"#fa755a",iconColor:"#fa755a"}}}),this.cardElement.mount(e),this.cardElement.on("change",(e=>{this.paymentError=e.error?.message||"",this.requestUpdate()}))}updated(e){super.updated(e),e.has("currentStep")&&(4===this.currentStep?this.setupStripeElement():this.cardElement&&(this.cardElement.unmount(),this.cardElement=null))}async firstUpdated(){this.applyDynamicColor(),setTimeout((()=>{this.setupStripeElement()}),100)}async fetchBookingSettings(){this.loading=!0;try{const e=await fetch(`https://horizondesk-api-0a74dafcd4fb.herokuapp.com/api/booking/settings/byAppId?appId=${this.widgetId}`,{headers:{"x-api-secret":this.apiSecret}});if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);const t=await e.json();this.stripeConfig=t.stripe||{},this.stripeConfig.publicKey||(console.error("Stripe public key is missing in the response data."),this.paymentError="Stripe public key is missing."),this.color=t.color||"#6366f1",this.applyDynamicColor(),this.updateGlobalStyles(),this.services=new Map(Object.entries(t.services||{}).map((([e,t])=>[e,{id:e,...t}]))),this.globalAdditionalServices=t.globalAdditionalServices||[],this.squareFootagePricing=t.squareFootagePricing||[]}catch(e){console.error("Failed to load booking settings:",e)}finally{this.loading=!1}}handleServiceSelect(e){const t=this.services.get(e);this.selectedService={id:e,...t},this.selectedExtras=[],this.selectedSquareFootage=null,this.showServiceDetails=!0,setTimeout((()=>{const e=document.getElementById("size-selection");e&&e.scrollIntoView({behavior:"smooth",block:"start"})}),100)}toggleExtra(e){const t=this.selectedExtras.some((t=>t.name===e.name));this.selectedExtras=t?this.selectedExtras.filter((t=>t.name!==e.name)):[...this.selectedExtras,e]}selectSquareFootage(e){this.selectedSquareFootage=e}confirmServiceSelection(){this.bookingData.serviceInfo={service:this.selectedService,extras:this.selectedExtras,squareFootage:this.selectedSquareFootage,subtotal:this.subtotal,total:this.total};const e=this.bathroomOptions.find((e=>e.value===this.selectedBathroom)),t=e?e.label:this.selectedBathroom;this.bookingData.additionalData=t,this.showServiceDetails=!1,this.nextStep()}formatMinutesToHours(e){const t=Math.floor(e/60),n=e%60;return t>0?`${t}h ${n}m`:`${n}m`}get subtotal(){return(this.selectedService?.price||0)+(this.selectedSquareFootage?.price||0)+this.selectedExtras.reduce(((e,t)=>e+(t.price||0)),0)}get total(){return this.subtotal}async nextStep(){if(this.formError="",2===this.currentStep){const{date:e,time:t,frequency:n}=this.bookingData.schedule;if(!e||!t||!n)return void(this.formError="Please select a date, time, and frequency.")}if(3===this.currentStep){const e=this.bookingData.generalInfo;if(!["name","email","phone","address","postalCode","state"].every((t=>e[t]?.trim())))return void(this.formError="Please fill in all personal details.")}this.currentStep<5&&(this.currentStep++,await this.updateComplete,this.scrollToStepTop(),4===this.currentStep&&(this.couponCode="",this.couponStatus=null,this.discountPercent=0,this.discountedTotal=null))}handleCouponInput(e){this.couponCode=e.target.value,this.couponStatus=null}async validateCoupon(){if(this.couponStatus=null,!this.couponCode||!this.bookingData?.serviceInfo?.total)return this.couponStatus={valid:!1,message:"Enter a coupon code."},void await this.requestUpdate();try{const e=encodeURIComponent(this.couponCode.trim()),t=this.bookingData.serviceInfo.total,n=`https://horizondesk-api-0a74dafcd4fb.herokuapp.com/api/coupons/validate/${e}?amount=${t}&clientId=${this.widgetId}`,i=await fetch(n,{headers:{"x-api-secret":this.apiSecret}});let r=null;try{r=await i.json()}catch(e){r={}}if(!i.ok||!r.valid)return this.couponStatus={valid:!1,message:r&&r.error?r.error:404===i.status?"Coupon not found for this client":"Invalid coupon."},this.discountPercent=0,this.discountedTotal=null,void await this.requestUpdate();this.discountPercent=r.discountPercent;const o=this.bookingData.serviceInfo.total,s=o*this.discountPercent/100;this.discountedTotal=Math.max(0,o-s),this.couponStatus={valid:!0,message:`Coupon applied! ${this.discountPercent}% off.`}}catch(e){this.couponStatus={valid:!1,message:"Error validating coupon."},this.discountPercent=0,this.discountedTotal=null}await this.requestUpdate()}async prevStep(){this.currentStep>1&&(this.currentStep--,await this.updateComplete,this.scrollToStepTop())}async scrollToStepTop(){try{await this.updateComplete;const e=`step-${this.currentStep}`,t=document.getElementById(e);if(!t)return void console.warn(`No se encontró el elemento con ID: ${e}`);t.scrollIntoView({behavior:"smooth",block:"start"}),await new Promise((e=>setTimeout(e,100)));const n=100,i=t.getBoundingClientRect().top;if(i>n+10||i<n-10){const e=window.scrollY+i-n,t=document.documentElement.style,r=t.scrollBehavior;t.scrollBehavior="auto",window.scrollTo(0,e),setTimeout((()=>{t.scrollBehavior=r}),50)}}catch(e){console.error("Error en scrollToStepTop:",e)}}handleScheduleChange(e){const{name:t,value:n}=e.target;this.bookingData.schedule={...this.bookingData.schedule,[t]:n}}handleGeneralInfoChange(e){const{name:t,value:n}=e.target;this.bookingData.generalInfo={...this.bookingData.generalInfo,[t]:n}}handleCardChange(e){const{name:t,value:n}=e.target;this.cardData={...this.cardData,[t]:n}}async completeBooking(){if(this.paymentProcessing=!0,this.paymentError="",!this.stripe)return this.paymentError="Stripe is not initialized.",void(this.paymentProcessing=!1);if(!this.cardElement||this.cardElement._empty)return this.paymentError="Please provide a valid card number.",void(this.paymentProcessing=!1);try{const{paymentMethod:e,error:t}=await this.stripe.createPaymentMethod({type:"card",card:this.cardElement,billing_details:{name:this.cardData.cardName,email:this.bookingData.generalInfo.email,address:{line1:this.bookingData.generalInfo.address,state:this.bookingData.generalInfo.state,postal_code:this.bookingData.generalInfo.postalCode}}});if(t)throw this.paymentError=t.message,new Error(t.message);const n=null!==this.discountedTotal?this.discountedTotal:this.bookingData.serviceInfo.total,i={bookingData:{appId:this.widgetId,services:{[this.bookingData.serviceInfo.service.id]:{name:this.bookingData.serviceInfo.service.name,price:this.bookingData.serviceInfo.service.price,additionalServices:this.bookingData.serviceInfo.extras,squareFootage:this.bookingData.serviceInfo.squareFootage}},subtotal:this.bookingData.serviceInfo.subtotal,total:n,clientInfo:this.bookingData.generalInfo,schedule:this.bookingData.schedule},paymentData:{paymentMethodId:e.id,currency:"usd",returnUrl:`${window.location.origin}/confirmation`}},r=await fetch("https://horizondesk-api-0a74dafcd4fb.herokuapp.com/api/booking/create-and-pay",{method:"POST",headers:{"Content-Type":"application/json","x-api-secret":this.apiSecret},body:JSON.stringify(i)}),o=await r.json();if(!r.ok)throw new Error(o.error||"Error processing the payment");if("succeeded"!==o.payment.status&&"requires_capture"!==o.payment.status)throw new Error("Payment failed.");this.bookingData.confirmation={bookingId:o.booking._id,paymentId:o.payment.paymentIntentId},this.nextStep()}catch(e){console.error("Error in completeBooking:",e),this.paymentError=e.message||"Error processing payment"}finally{this.paymentProcessing=!1}}resetBooking(){this.currentStep=1,this.selectedService=null,this.selectedExtras=[],this.selectedSquareFootage=null,this.selectedBathrooms=[],this.selectedBathroom="",this.showServiceDetails=!1,this.cardData={cardNumber:"",cardName:"",expiryDate:"",cvv:""},this.bookingData={serviceInfo:null,schedule:{date:"",time:"",frequency:"one-time",notes:""},generalInfo:{name:"",email:"",phone:"",address:"",postalCode:"",state:""},payment:{method:"card"},additionalData:[]}}formatCardNumber(e){let t=e.target.value.replace(/\D/g,"");t=t.replace(/(\d{4})/g,"$1 ").trim(),e.target.value=t,this.cardData.cardNumber=t}formatExpiryDate(e){let t=e.target.value.replace(/\D/g,"");t.length>2&&(t=t.substring(0,2)+"/"+t.substring(2,4)),e.target.value=t,this.cardData.expiryDate=t}adjustColor(e,t){if(!e||"#"!==e[0])return e;3===(e=e.replace("#","")).length&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]);let n=parseInt(e.substr(0,2),16),i=parseInt(e.substr(2,2),16),r=parseInt(e.substr(4,2),16);n=Math.max(0,Math.min(255,n+t)),i=Math.max(0,Math.min(255,i+t)),r=Math.max(0,Math.min(255,r+t));return`#${n.toString(16).padStart(2,"0")}${i.toString(16).padStart(2,"0")}${r.toString(16).padStart(2,"0")}`}updated(e){e.has("color")&&this.applyDynamicColor()}applyDynamicColor(){this.style.setProperty("--primary-color",this.color),this.style.setProperty("--primary-light",this.adjustColor(this.color,20)),this.style.setProperty("--primary-dark",this.adjustColor(this.color,-20))}render(){return N`
    ...
    `}renderStep1(){return N`
      <div class="step-content" id="step-1">
        <h3>Choose Your Service</h3>
        ${this.loading?N` <div class="loading"><div class="spinner"></div></div> `:N`
              <div class="size-options">
                ${Array.from(this.services.entries()).map((([e,t])=>N`
                    <div
                    ...
                    >
                      ...
                      ${t.time?N`<div class="size-time">
                            ${this.formatMinutesToHours(t.time)}
                          </div>`:""}
                      ${this.selectedService?.id===e?N`<div class="selected-indicator">✓</div>`:""}
                    </div>
                  `))}
              </div>
            `}
        ${this.showServiceDetails&&this.selectedService?N`
              <div class="service-details-container">
                ...
                ${this.squareFootagePricing.length>0?N`
                      <div class="size-selection" id="size-selection">
                        ...
                        >
                          ...
                          ${this.squareFootagePricing.map((e=>N`
                              <option
                                value=${e.range}
          ...
          "
                        >
                          <input
                            ...
                            name="bathroomType"
                            value="${e.value}"
                            .checked=${this.selectedBathroom===e.value}
                            @change=${this.handleBathroomRadio.bind(this)}
                            style="accent-color: var(--primary-color); margin-bottom: 0.3rem;"
                          />
                          <span style="line-height: 1.2;">${e.label}</span>
                        </label>
                      `))}
                  </div>
                </div>

                ${this.selectedService.additionalServices?.length>0||this.globalAdditionalServices.length>0?N`
                      <div class="extras-section">
                        <h3>Select Add-ons</h3>
                        <div class="size-options">
                          ${[...this.selectedService.additionalServices||[],...this.globalAdditionalServices].map((e=>N`
                              <div
    ...
    `}renderStep2(){const e=[];for(let t=this.businessHours.start;t<=this.businessHours.end;t++)for(let n=0;n<60;n+=15){const i=`${String(t).padStart(2,"0")}:${String(n).padStart(2,"0")}`;e.push(i)}const t=new Date;t.setHours(0,0,0,0);const n=t.toISOString().split("T")[0];return N`
      <div class="step-content" id="step-2">
        <div class="form-container">
          <h3>Schedule Your Service</h3>
          ${this.formError?N`<div class="error-message" style="margin-bottom: 1rem;">
                ${this.formError}
              </div>`:""}
    ...
    `}renderStep4(){setTimeout((()=>{4===this.currentStep&&this.setupStripeElement()}),100);const e=this.couponStatus&&"string"==typeof this.couponStatus.message&&this.couponStatus.message.startsWith("Coupon applied!");return N`
      <div class="step-content" id="step-4">
        <div class="form-container">
          ...
          <div class="form-group" style="margin-bottom:1.5rem;">
            ...
            ${this.couponStatus&&void 0!==this.couponStatus.message?N`<div class="${e?"success-message":"error-message"}" style="margin-top:0.5rem;">
          ...
          <div class="summary-card">
            ...
            ${this.bookingData.additionalData?N`
                ...
                `:""}
            ${this.bookingData.serviceInfo?.squareFootage?N`
                  <div class="summary-item">
                ...
                `:""}
            ${this.bookingData.serviceInfo?.extras?.length>0?this.bookingData.serviceInfo.extras.map((e=>N`
                    <div class="summary-item">
                      <span>${e.name}:</span>
                      <span>+$${e.price}</span>
                    </div>
            ...
            ${this.discountPercent>0&&null!==this.discountedTotal?N`
          ...
          ${this.paymentError?N`<div class="error-message">${this.paymentError}</div>`:""}
    ...
    `}updated(e){super.updated(e),e.has("currentStep")&&4===this.currentStep&&this.setupStripeElement()}renderStep5(){return N`
      <div class="step-content">
        <div class="confirmation-container">
          ...
          <div class="confirmation-details">
            ...
            ${this.bookingData.serviceInfo?.squareFootage?N`
                ...
                `:""}
            ${this.bookingData.serviceInfo?.extras?.length>0?N`
                  ${this.bookingData.serviceInfo.extras.map((e=>N`
                      <div class="summary-item">
                        <span>${e.name}:</span>
                        <span>+$${e.price}</span>
                      </div>
            ...
            ${this.bookingData.confirmation?N`
                  <div class="summary-item">
